...
function TriggerServerCallback(name, cb, ...)
	...
	TriggerServerEvent('azakit_delivery:triggerServerCallback', name, CurrentRequestId, ...)
...
RegisterNetEvent('azakit_delivery:serverCallback')
AddEventHandler('azakit_delivery:serverCallback', function(requestId, ...)
